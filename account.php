    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="web.facebook.com/umair.ali52378/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Umair Ali</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+92 3449546019</h4>
		<h4 style="font-family:'typo' ">softwareengieer.hu@gmail.com</h4>
		<h4 style="font-family:'typo' ">Hazara University Masnehra</h4></div></div>
		</p>
      </div>
